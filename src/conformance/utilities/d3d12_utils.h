...
namespace Conformance
{
    ...
    public:
        ...
        /// Allocate (or discard and re-allocate) buffers suitable for an array of @p maxCapacity elements (defaulting to a single element)
        void Allocate(_In_ ID3D12Device* device, size_t maxCapacity = 1)
        {
    ...
    private:
        ...
        static size_t RequiredBytesFor(size_t count)
        {
