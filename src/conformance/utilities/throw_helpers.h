...
namespace Conformance
{
     ...
     *
     * Code in the framework itself should generally use exceptions, rather than assertion macros, for thread safety and to avoid inflating the assertion count.
     *
