...
namespace Conformance
{
    ...
    static inline std::string vkResultString(VkResult res)
    {
        switch (res) {
        case VK_SUCCESS:
            return "SUCCESS";
...
#define LIST_PIPE_STAGES(_)           \
    ...
    static inline std::string GetPipelineStages(VkPipelineStageFlags stages)
    {
        std::string desc;
...
#undef MK_PIPE_STAGE_CHECK
    ...
    [[noreturn]] static inline void ThrowVkResult(VkResult res, const char* originator = nullptr, const char* sourceLocation = nullptr)
    {
...
#define SHOW_CHECKPOINTS() \
    ...
    static inline VkResult CheckThrowVkResult(VkResult res, const char* originator = nullptr, const char* sourceLocation = nullptr)
    {
        if ((res) < VK_SUCCESS) {
            SHOW_CHECKPOINTS();
