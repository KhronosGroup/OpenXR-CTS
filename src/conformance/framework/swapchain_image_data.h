...
namespace Conformance
{
    ...
    public:
        ...
        /// Returns a pointer to the XrSwapchainCreateInfo used to create the depth swapchain, or nullptr if fallback depth textures are used instead.
    ...
    private:
        ...
        {
            return SwapchainImageDerivedType{m_derivedTypeConstant};
        }
    ...
    template <typename SwapchainImageDerivedType>
    inline SwapchainImageDerivedType SwapchainImageDataBase<SwapchainImageDerivedType>::GetDepthImageForColorIndex(uint32_t colorImageIndex)
    {
        if (DepthSwapchainEnabled()) {
    ...
    template <typename SwapchainImageDerivedType>
    inline XrSwapchainImageBaseHeader* SwapchainImageDataBase<SwapchainImageDerivedType>::GetGenericColorImage(uint32_t colorImageIndex)
    {
    ...
    public:
        ...
        /// Given a base pointer for a color swapchain image, look up the image data object and swapchain image index associated with it.
