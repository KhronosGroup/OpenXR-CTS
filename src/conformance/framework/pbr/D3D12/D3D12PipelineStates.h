...
namespace Pbr
{
    ...
    public:
        ...
        D3D12PipelineStates(Microsoft::WRL::ComPtr<ID3D12RootSignature> rootSignature,
                            ...
                            span<const D3D12_INPUT_ELEMENT_DESC> inputLayout,                  //
                            span<const unsigned char> pbrVS, span<const unsigned char> pbrPS,  //
                            span<const unsigned char> unlitVS, span<const unsigned char> unlitPS)
    ...
    private:
        using PipelineStateKey =
            std::tuple<DXGI_FORMAT, DXGI_FORMAT, Shader, FillMode, FrontFaceWindingOrder, BlendState, DoubleSided, DepthDirection>;
        ...
        span<const unsigned char> m_unlitVS;
        span<const unsigned char> m_unlitPS;
